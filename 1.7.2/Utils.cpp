...
UObject* SDK::InternalGet(FSoftObjectPtr* Ptr, UClass* Class)
{
    ...
    if ((!Ret || !Ret->IsA(Class)) && Ptr->ObjectID.AssetLongPathname) {
        Ptr->WeakPtr = Ret = Utils::FindObject(Ptr->ObjectID.AssetLongPathname.CStr(), Class);
    }
    return Ret;
}
...
AActor* Utils::SpawnActor(UClass* Class, FTransform& Transform, AActor* Owner)
{
    ...
    return ((AActor * (*)(UWorld*, UClass*, FTransform const*, FActorSpawnParameters*))(ImageBase + 0x21d6c90))(UWorld::GetWorld(), Class, &Transform, &addr);
...
AActor* Utils::SpawnActor(UClass* Class, FVector& Loc, FRotator& Rot, AActor* Owner)
{
    ...
    return ((AActor * (*)(UWorld*, UClass*, FVector const*, FRotator const*, FActorSpawnParameters*))(ImageBase + 0x21d7bd0))(UWorld::GetWorld(), Class, &Loc, &Rot, &addr);
}
