...
#define Log(format, ...) ((void(*)(const char*, int32, const FName&, uint8, const wchar_t*, ...)) (ImageBase + 0x1270770))(__FILE__, __LINE__, LogCategory, 4, format, ##__VA_ARGS__);
...
public:
    ...
    {
        return ((_It * (*)(UObject*, UClass*)) (ImageBase + 0xdddbe0))(Object, _It::StaticClass());
    }
