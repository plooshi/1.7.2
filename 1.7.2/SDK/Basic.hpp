...
namespace Offsets
{
	...
	constexpr int32 GWorld            = 0x0674AAD0;
...
public:
	...
	FName(int32 _Ci = 0, int32 _Nb = 0)
		: ComparisonIndex(_Ci), Number(_Nb)
	{
	...
	std::string GetRawString() const
	{
		...
		std::string OutputString = TempString.ToString().c_str();
		TempString.Clear();
...
public:
	...
	std::string ToString() const
	{
		return TextData->TextSource.ToString().c_str();
	}
};
